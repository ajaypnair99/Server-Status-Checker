...
This is a simple server status checker, made to check if the server is up. I made it as a side project because I was bored, took about 10 minutes to make this.
...
Issues : Sometimes the status comes in as the website is down, even though its working. It only happens with some websites 
